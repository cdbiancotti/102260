class CalculadoraBasica:
    ...
    def sumar(self):
        valor1, valor2 = self.solicitar_valores()
        self.imprimir_resultado(valor1 + valor2)
    ...
    def dividir(self):
        ...
        # V2
        valores = self.solicitar_valores()
        resultado = valores[0]
    ...
    def solicitar_valores(self):
        ...
        while True:
            ...
            if input("Quiere ingresar otro? (si por positivo)") == 'si':
                continue
            break
        return valores
...
class CalculadoraConMemoria(CalculadoraBasica):
    ...
    def imprimir_resultado(self, resultado):
        ...
        super().imprimir_resultado(resultado)

calculadora = CalculadoraConMemoria()
calculadora.encendido()
